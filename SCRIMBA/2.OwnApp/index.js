...
const App = (props) => {
  ...
  // RETO:
  // CAMBIAR EL QUERY POR UNO DE TUS INTERESES
  let [query, setQuery] = useState("watercolors"); //Hook para agregar contenido, debe de estar entre las comillas
...
// RETO: AGREGA TU NOMBRE Y EMOJI AL WEBSITE
ReactDOM.render(<App name="Daniel" emoji="🎨🖌️"/>, document.getElementById("root"));
